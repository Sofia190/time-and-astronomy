...
from .views_1st import start, welcome
...
display_DaysInSearchEngine,

determine_the_aparent_magnitude,

determine_the_absolute_magnitude,

delete_objs_used_in_calculations,

determine_distance_from_Earth,

determine_the_ratio_in_brightness_between_visible_stars,

convert_light_years_in_parsecs,

calculate_the_annual_paralax,

calculate_sum_of_attributes_of_nth_day,

determine_visibility_of_a_star_in_seasons,

calculate_the_flux_density,

find_which_stars_are_visible_in_equinox_dates,

find_which_stars_are_visible_in_autumn_equinox_dates,

find_which_stars_are_visible_in_summer_solstice_dates,

find_which_stars_are_visible_in_winter_solstice_dates,

display_stars_most_visible_in_equinox_dates,

display_stars_most_visible_in_solstice_dates,

display_stars_in_equinox_dates,

display_stars_in_solstice_dates,

delete_the_DaysInSearchEngine_using_ids,

set_total_lunar_eclipses,

find_periods_with_total_lunar_eclipses_with_stars_most_visible,

determine_the_relative_position_of_stars,

display_site_pages,

display_aux_pages,

display_astronomy_pages,)
...
, name="view_how_many_bisect_years_in_the_last_nth_centuries"),
    ...
    path('solstices-in-n-years-with-sum-attrs-even-number/', how_many_solstices_in_n_years_with_sum_attrs_even_number,
      ...
      path('display-days/<int:id>/', display_DaysInSearchEngine, name="display_DaysInSearchEngine"),

      path('determine-the-aparent-magnitude/', determine_the_aparent_magnitude, 
        name="determine_the_aparent_magnitude"),

      path('determine-the-absolute-magnitude/', determine_the_absolute_magnitude,

        name="determine-the-absolute-magnitude"),

      path('delete-objects-used-in-calculations/', delete_objs_used_in_calculations,

        name="delete_objs_used_in_calculations"),

      path('determine-distance-from-Earth/', determine_distance_from_Earth,
        name="determine_distance_from_Earth"),

      path('determine-the-ratio-in-brightness/', determine_the_ratio_in_brightness_between_visible_stars,

        name="determine_the_ratio_in_brightness_between_visible_stars"),

      path("convert-light-years-in-parsecs/", convert_light_years_in_parsecs,

        name="convert_light_years_in_parsecs"),

      path('calculate-the-annual-paralax/', calculate_the_annual_paralax,

        name="calculate_the_annual_paralax"),

      path('calculate-sum-of-attributes-of-nth-day', calculate_sum_of_attributes_of_nth_day,

        name="calculate_sum_of_attributes_of_nth_day"),

      path('visibility-of-a-star-in-seasons/', determine_visibility_of_a_star_in_seasons,

        name="determine_visibility_of_a_star_in_seasons"),

      path('calculate-the-flux-density/', calculate_the_flux_density, name="calculate_the_flux_density"),

      path('find-which-stars-are-visible-in-equinox-dates/', find_which_stars_are_visible_in_equinox_dates,

        name="find_which_stars_are_visible_in_equinox_dates"),

      path('find-which-stars-are-visible-in-autumn-equinox-dates/', find_which_stars_are_visible_in_autumn_equinox_dates,

        name="find_which_stars_are_visible_in_autumn_equinox_dates"),

     path('find-which-stars-are-visible-in-summer-solstice-dates/', find_which_stars_are_visible_in_summer_solstice_dates,

        name="find_which_stars_are_visible_in_summer_solstice_dates"),

      path('find-which-stars-are-visible-in-winter-solstice-dates/', find_which_stars_are_visible_in_winter_solstice_dates,

        name="find_which_stars_are_visible_in_winter_solstice_dates"),

      path('stars-visible-in-equinox-dates/', display_stars_most_visible_in_equinox_dates,

        name="display_stars_most_visible_in_equinox_dates"),

      path('stars-visible-in-solstice-dates/', display_stars_most_visible_in_solstice_dates,

        name="display_stars_most_visible_in_solstice_dates"),

      path('display-stars-in-equinox-dates/', display_stars_in_equinox_dates,

        name="display_stars_in_equinox_dates"), 

      path('display-stars-in-solstice-dates/', display_stars_in_solstice_dates,
      ...
      path("set-total-lunar-eclipses/", set_total_lunar_eclipses, name="set_total_lunar_eclipses"),

      path('total-lunar-eclipses-stars-most-visible/', find_periods_with_total_lunar_eclipses_with_stars_most_visible,

        name=" find_periods_with_total_lunar_eclipses_with_stars_most_visible" ),
      ...
      path("start-page/site-pages/", display_site_pages, name="display_site_pages"),

      path("aux-pages/", display_aux_pages, name="display_aux_pages"),

      path("start-page/aux-pages/", display_aux_pages, name="display_aux_pages"),

      path("astronomy/", display_astronomy_pages, name="display_astronomy_pages"),
      ...
      path('start-page/aux-pages/delete-days/', delete_the_DaysInSearchEngine, name="delete_the_DaysInSearchEngine"),

      path('start-page/aux-pages/determine-visibility-of-stars/', determine_visibility_of_stars, name="determine_visibility_of_stars"),

      path('start-page/aux-pages/ref-magnitudes/', ref_magnitudes, name="ref_magnitudes"),

      path('start-page/aux-pages/determine-most-visible-periods/', determine_most_visible_periods, name="determine_most_visible_periods"),

      path('start-page/aux-pages/set-season/', set_season, name="set_season"),

      path('start-page/aux-pages/determine-most-visible-periods-seasons/', determine_most_visible_periods_seasons, name="determine_most_visible_periods_seasons"),

      path('start-page/aux-pages/set-spring-equinox/', set_spring_equinox, name="set_spring_equinox"),

      path('start-page/aux-pages/set-autumn-equinox/', set_autumn_equinox, name="set_autumn_equinox"),

      path('start-page/aux-pages/set-summer-solstice/', set_summer_solstice, name="set_summer_solstice"),

      path('start-page/aux-pages/set-winter-solstice/', set_winter_solstice, name="set_winter_solstice"),
      ...
      path('start-page/aux-pages/visibility-of-a-star-in-seasons/', determine_visibility_of_a_star_in_seasons,

      name="determine_visibility_of_a_star_in_seasons"),

       path('start-page/aux-pages/find-which-stars-are-visible-in-equinox-dates/', find_which_stars_are_visible_in_equinox_dates,

        name="find_which_stars_are_visible_in_equinox_dates"),

      path('start-page/aux-pages/find-which-stars-are-visible-in-autumn-equinox-dates/', find_which_stars_are_visible_in_autumn_equinox_dates,

        name="find_which_stars_are_visible_in_autumn_equinox_dates"),

     path('start-page/aux-pages/find-which-stars-are-visible-in-summer-solstice-dates/', find_which_stars_are_visible_in_summer_solstice_dates,

        name="find_which_stars_are_visible_in_summer_solstice_dates"),

      path('start-page/aux-pages/find-which-stars-are-visible-in-winter-solstice-dates/', find_which_stars_are_visible_in_winter_solstice_dates,

        name="find_which_stars_are_visible_in_winter_solstice_dates"),

      path('start-page/aux-pages/stars-visible-in-equinox-dates/', display_stars_most_visible_in_equinox_dates,

        name="display_stars_most_visible_in_equinox_dates"),

      path('start-page/aux-pages/stars-visible-in-solstice-dates/', display_stars_most_visible_in_solstice_dates,

        name="display_stars_most_visible_in_solstice_dates"),

      path('start-page/site-pages/astronomy/display-stars-in-equinox-dates/', display_stars_in_equinox_dates,

        name="display_stars_in_equinox_dates"), 

      path('start-page/site-pages/astronomy/display-stars-in-solstice-dates/', display_stars_in_solstice_dates,

        name="display_stars_in_solstice_dates"),

      path('start-page/aux-pages/delete-the-DaysInSearchEngine-using-ids/', delete_the_DaysInSearchEngine_using_ids,

        name="delete_the_DaysInSearchEngine_using_ids"),

      path("start-page/aux-pages/set-total-lunar-eclipses/", set_total_lunar_eclipses, name="set_total_lunar_eclipses"),

       path('start-page/aux-pages/determine-the-relative-position-of-stars/', determine_the_relative_position_of_stars,
      ...
      path('start-page/site-pages/astronomy/determine-the-ratio-in-brightness/', determine_the_ratio_in_brightness_between_visible_stars,

        name="determine_the_ratio_in_brightness_between_visible_stars"),

      path("start-page/site-pages/astronomy/convert-light-years-in-parsecs/", convert_light_years_in_parsecs,

        name="convert_light_years_in_parsecs"),

      path('start-page/site-pages/astronomy/calculate-the-annual-paralax/', calculate_the_annual_paralax,

        name="calculate_the_annual_paralax"),

      path('start-page/site-pages/astronomy/calculate-the-flux-density/', calculate_the_flux_density, name="calculate_the_flux_density"),
