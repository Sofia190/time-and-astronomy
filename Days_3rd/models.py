...
class DaysInSearchEngineModelManager(models.Manager):


	def get_queryset(self):
		    return DaysInSearchEngineQuerySet(self.model, using=self._db)
	...
	def get_time_frame(self, date1, date2):
			...
			qs_time_1 = qs.filter(date_field__gte=date1)

			qs_time_2=qs_time_1.filter(date_field__lte=date2) 
...
class Day(models.Model):
	...
	date_to_sum_all_attributes = models.DateField(auto_now=False, auto_now_add=False, default=timezone.now())
	# date_to_sum_attributes_days = models.IntegerField(default=0)
	nth_day_value_all_attributes = models.IntegerField(default=0)
	nth_month_value_all_attributes = models.IntegerField(default=0)

	hour_all_attributes = models.IntegerField(default=0)
	minute_all_attributes = models.IntegerField(default=0)
	second_all_attributes = models.IntegerField(default=0)

	date_to_sum_all_attributes_result = models.IntegerField(default=0)
...
class DaysInSearchEngine(models.Model):
		...
		year_one_period  = models.IntegerField(default=0)

		year_two_period = models.IntegerField(default=0)
		...
		most_visible_periods = models.TextField(default="time")

		most_visible_periods_seasons = models.TextField(default="time")
		...
		first_id_ref_magnitudes = models.IntegerField(default=0)

		second_id_ref_magnitudes = models.IntegerField(default=0)


		first_id_most_visible_periods = models.IntegerField(default=0)

		second_id_most_visible_periods = models.IntegerField(default=0)


		first_id_most_visible_periods_seasons = models.IntegerField(default=0)

		second_id_most_visible_periods_seasons = models.IntegerField(default=0)


		first_id_set_season = models.IntegerField(default=0)

		second_id_set_season = models.IntegerField(default=0)


		first_id_set_spring_equinox = models.IntegerField(default=0)

		second_id_set_spring_equinox = models.IntegerField(default=0)


		first_id_set_autumn_equinox = models.IntegerField(default=0)

		second_id_set_autumn_equinox = models.IntegerField(default=0)


		first_id_set_summer_solstice = models.IntegerField(default=0)

		second_id_set_summer_solstice = models.IntegerField(default=0)


		first_id_set_winter_solstice = models.IntegerField(default=0)

		second_id_set_winter_solstice = models.IntegerField(default=0)


		first_id_determine_stars_movement = models.IntegerField(default=0)

		second_id_determine_stars_movement = models.IntegerField(default=0)




		first_id_stars_equinoxes = models.IntegerField(default=0)

		second_id_stars_equinoxes = models.IntegerField(default=0)

		first_id_stars_solstices = models.IntegerField(default=0)

		second_id_stars_solstices = models.IntegerField(default=0)


		first_id_set_total_lunar_eclipses = models.IntegerField(default=0)

		second_id_set_total_lunar_eclipses = models.IntegerField(default=0)


		id_one_objs_to_delete = models.IntegerField(default=0)

		id_two_objs_to_delete = models.IntegerField(default=0)

		first_date_period_total_lunar_eclipse = models.DateField(auto_now=False, auto_now_add=False, default=timezone.now())

		second_date_period_total_lunar_eclipse = models.DateField(auto_now=False, auto_now_add=False, default=timezone.now())
	
		list_stars_most_visible_lunar_eclipses = models.TextField(default="time")
...
class Stars(models.Model):
	...
	ascension = models.FloatField(default=0)

	declination = models.FloatField(default=0)

	aparent_magnitude = models.FloatField(default=0, blank=True)

	absolute_magnitude = models.FloatField(default=0)

	distance_from_Earth = models.FloatField(default=0)

	stars_temperature = models.IntegerField(default=0)

	count = models.IntegerField(default=22)


	absolute_magnitude_calculation = models.FloatField(default=0)

	distance_from_Earth_calculation = models.FloatField(default=0)

	aparent_magnitude_calculation = models.FloatField(default=0)

	used_in_calculations = models.BooleanField(default=False)

	first_aparent_magnitude_ratio_brightness = models.FloatField(default=0)

	second_aparent_magnitude_ratio_brightness = models.FloatField(default=0)

	ratio_in_brightness_res = models.FloatField(default=0)


	light_years = models.FloatField(default=0)

	light_years_in_parsecs = models.FloatField(default=0)


	distance_from_Earth_paralax = models.FloatField(default=0)

	paralax_res = models.FloatField(default=0)


	seasons_visibility = models.TextField(default="time")

	seasons_visibility_var = models.TextField(default="time")

	absolute_magnitude_flux_density = models.FloatField(default=0)

	telescope_aperture = models.FloatField(default=0)

	flux_density_res = models.FloatField(default=0)


	stars_in_equinox_dates = models.TextField(default="time")

	stars_in_autumn_equinox_dates = models.TextField(default="time")

	stars_in_solstice_dates = models.TextField(default="time")

	stars_in_winter_solstice_dates = models.TextField(default="time")


	stars_in_equinox_dates_res = models.TextField(default="time")

	stars_in_solstice_dates_res = models.TextField(default="time")


	m24_pleiades_list = models.TextField(default="names", blank=True)

	hyades_list = models.TextField(default="names", blank=True)

	m38_list = models.TextField(default="names", blank=True)

	m37_list = models.TextField(default="names", blank=True)

	m35_list = models.TextField(default="names", blank=True)

	h72_list = models.TextField(default="names", blank=True)

	m41_list = models.TextField(default="names", blank=True)

	m50_list = models.TextField(default="names", blank=True)

	m44_praesepe_list = models.TextField(default="names", blank=True)

	m67_list = models.TextField(default="names", blank=True)

	m23_list = models.TextField(default="names", blank=True)

	m11_list = models.TextField(default="names", blank=True)

	h875_list = models.TextField(default="names", blank=True)

	m52_list = models.TextField(default="names", blank=True)

	m630_list = models.TextField(default="names", blank=True)

	m633_634_list = models.TextField(default="names", blank=True)

	m68_list = models.TextField(default="names", blank=True)

	m3_list = models.TextField(default="names", blank=True)

	m19_list = models.TextField(default="names", blank=True)

	m13_list = models.TextField(default="names", blank=True)

	m19_list = models.TextField(default="names", blank=True)

	m9_list = models.TextField(default="names", blank=True)

	m2_list = models.TextField(default="names", blank=True)

	h627_list = models.TextField(default="names", blank=True)

	m97_list = models.TextField(default="names", blank=True)

	h473_list = models.TextField(default="names", blank=True)

	m57_list = models.TextField(default="names", blank=True)

	m27_list = models.TextField(default="names", blank=True)

	m418_list = models.TextField(default="names", blank=True)

	m1_list = models.TextField(default="names", blank=True)

	m42_list = models.TextField(default="names", blank=True)

	m20_list = models.TextField(default="names", blank=True)

	m8_list = models.TextField(default="names", blank=True)

	m24_list = models.TextField(default="names", blank=True)

	m31_list = models.TextField(default="names", blank=True)

	m33_list = models.TextField(default="names", blank=True)

	m51_list = models.TextField(default="names", blank=True)
